...
snippet1 = Snippet.create!(user: user1, title: 'Ruby String Manipulation', description: 'A code snippet demonstrating string manipulation in Ruby', code: "string = 'Hello, World!'\nputs string.upcase\nputs string.reverse", language: 'Ruby')
snippet2 = Snippet.create!(user: user2, title: 'Arduino Blink LED', description: 'A basic Arduino sketch to blink an LED', code: "int ledPin = 13;\n\nvoid setup() {\n  pinMode(ledPin, OUTPUT);\n}\n\nvoid loop() {\n  digitalWrite(ledPin, HIGH);\n  delay(1000);\n  digitalWrite(ledPin, LOW);\n  delay(1000);\n}", language: 'Arduino')
snippet3 = Snippet.create!(user: user3, title: 'FizzBuzz Algorithm', description: "Algorithm that prints numbers from 1 to 100, but for multiples of three, it prints 'Fizz' instead of the number and for the multiples of five, it prints 'Buzz'. For numbers which are multiples of both three and five, it prints 'FizzBuzz'.", code: "for (let i = 1; i <= 100; i++) {\n  if (i % 3 === 0 && i % 5 === 0) {\n    console.log('FizzBuzz');\n  } else if (i % 3 === 0) {\n    console.log('Fizz');\n  } else if (i % 5 === 0) {\n    console.log('Buzz');\n  } else {\n    console.log(i);\n  }\n}", language: 'JavaScript')
snippet4 = Snippet.create!(user: user5, title: 'Factorial Program', description: "A program that calculates the factorial of a given number.", code: "function factorial(n) {\n  if (n <= 1) {\n    return 1;\n  }\n  return n * factorial(n - 1);\n}", language: "JavaScript")
snippet5 = Snippet.create!(user: user1, title: 'GDScript Timer', description: 'A code snippet demonstrating the use of a Timer in GDScript', code: "extends Node\n\nvar timer = Timer.new()\n\nfunc _ready():\n    timer.wait_time = 2.0\n    timer.one_shot = false\n    timer.connect('timeout', self, '_on_Timer_timeout')\n    timer.start()\n\nfunc _on_Timer_timeout() -> void:\n    print('Timer expired')", language: 'GDScript')
snippet6 = Snippet.create!(user: user1, title: 'PHP File Handling', description: 'A code snippet demonstrating file handling in PHP', code: "<?php\n$file = fopen('example.txt', 'r');\necho fread($file, filesize('example.txt'));\nfclose($file);\n?>", language: 'PHP')
snippet7 = Snippet.create!(user: user2, title: 'Database Connection in Go', description: 'A code snippet for connecting to a database in Go', code: "package main\n\nimport (\n    'database/sql'\n    _ 'github.com/go-sql-driver/mysql'\n    'log'\n)\n\nfunc main() {\n    db, err := sql.Open('mysql', 'user:password@tcp(127.0.0.1:3306)/database')\n    if err != nil {\n        log.Fatal(err)\n    }\n    defer db.Close()\n\n    // Rest of the code...\n}", language: 'GO')
snippet8 = Snippet.create!(user: user3, title: 'Python Fibonacci Sequence', description: 'A Python function to generate the Fibonacci sequence', code: "def fibonacci(n):\n    fib = [0, 1]\n    for i in range(2, n+1):\n        fib.append(fib[i-1] + fib[i-2])\n    return fib\n\nprint(fibonacci(10))", language: 'Python')
snippet9 = Snippet.create!(user: user4, title: 'JavaScript Event Listener', description: 'A code snippet demonstrating an event listener in JavaScript', code: "document.getElementById('myButton').addEventListener('click', function() {\n    alert('Button clicked!');\n});", language: 'JavaScript')
